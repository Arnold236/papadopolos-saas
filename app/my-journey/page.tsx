...
import { getUserCompanions, getUserRecentSessions } from '@/lib/actions/companion.actions';
...
const Profile = async () => {
  ...
  const sessionHistory = getUserRecentSessions(user.id);
      ...
      <section className='flex justify-between gap-4 max-sm:flex-col items-center'>
        <div className="flex gap-4 items-center ">
          ...
          <div className="flex flex-col gap-2">
            <h1 className='font-black text-2xl'>{user.firstName} {user.lastName}</h1>
