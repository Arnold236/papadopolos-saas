...
const formSchema = z.object({
  name: z.string().min(1, { message: "Companiion is required"}),
...
const CompanionForm = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    if (companion) {
      ...
      console.log("Failed to create a compau=ion");
      redirect('/');
    }
  }
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>Companion namname</FormLabel>
              <FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea placeholder="Ex. Derivitive & Integrals " {...field} className="input"/>
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
